...
const objLat = (obj) => {
    ...
    let firstNameUpper = obj.firstName.charAt(0).toUpperCase() + obj.firstName.substring(1);
    let lastNmaeUpper = obj.lastName.charAt(0).toUpperCase() + obj.lastName.substring(1);
    return `my name is ${firstNameUpper} ${lastNmaeUpper} I am ${obj.age} YO, and I love ${obj.hobby}.`
};
